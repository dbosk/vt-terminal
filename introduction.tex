...
% TODO(#2): Once the systematic search phase has run, revisit whether the SSH
% part has enough literature to stand as its own contribution or whether it
% remains an aspect analysis grounded in course observations.
