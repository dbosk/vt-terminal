...
as the GUI}).
Every aspect has an item in the pre/post-test of \cref{app:quiz}, which
is what will turn \enquote{candidate} into \enquote{critical} or not.
...
\begin{table}
  \begin{sidecaption}{The candidate critical aspects, what each is read
    ...
    \begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.36\linewidth}l>{\raggedright\arraybackslash}p{0.34\linewidth}@{}}
      ...
      The pipe is not the file & literature & sending output into a pipe \\
